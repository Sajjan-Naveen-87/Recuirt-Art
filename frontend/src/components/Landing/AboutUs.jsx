...
function AboutUs() {
  ...
  return (
    <section id="about-us" className="bg-[#0c0e14] relative overflow-hidden scroll-mt-32">
      {/* Our Story Section */}
      <div className="flex flex-col lg:flex-row min-h-[600px] lg:min-h-[800px]">
        {/* Left side - Image */}
        <div className="w-full lg:w-1/2 bg-[#0c0e14] relative flex items-center h-[500px] md:h-[600px] lg:h-auto p-4 lg:p-0">
        ...
        {/* Right side - Text */}
        <div className="w-full lg:w-1/2 bg-[#0c0e14] flex items-center justify-center p-10 md:p-20 lg:p-24 relative overflow-hidden text-white">
          <div className="max-w-xl relative z-10 w-full space-y-10 md:space-y-16 py-8 md:py-12">
            <div>
              <h4 className="text-[14px] font-black uppercase tracking-[0.8em] text-[#FFC107] mb-6">Established in 2019</h4>
            ...
            <div className="space-y-6 md:space-y-8">
              <p className="text-slate-400 text-base md:text-lg leading-relaxed font-medium">
                <strong className="text-white">Recruit Art </strong> - Hiring Experts was founded by <strong className="text-white">Sahitya Saini</strong>, a healthcare recruitment specialist with over a decade of experience. His journey began with structured workforce planning within healthcare institutions, leading campus drives and setup recruitments across India.
              </p>
              <p className="text-slate-400 text-base md:text-lg leading-relaxed font-medium">
            ...
            {/* <a href="#services" className="inline-block bg-[#FFC107] text-[#0c0e14] px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#FFC107]/10 hover:scale-105 transition-all">
              Learn More
            </a> */}
          </div>
        </div>
      ...
      <div id="portfolio" className="w-full bg-[#0c0e14] py-20 xl:py-16 relative overflow-hidden flex flex-col xl:flex-row items-center justify-between shadow-2xl min-h-[650px] border-t border-white/5 scroll-mt-32">
        ...
        <div className="w-full xl:w-1/3 bg-[#f8f9fa] h-[400px] md:h-[500px] xl:h-[520px] relative z-10 rounded-[4rem] xl:rounded-none xl:rounded-r-full mx-6 xl:mx-0 box-border flex flex-col items-center justify-center p-12 lg:p-20 shadow-2xl">
            <h4 className="text-[12px] font-black text-[#0c0e14] uppercase tracking-[0.8em] mb-10">Our Clients</h4>
        ...
        <div className="w-full xl:w-1/3 flex flex-col md:flex-row xl:flex-col gap-12 md:gap-8 xl:gap-16 text-center text-white relative z-10 py-16 xl:py-0 px-8 items-center justify-center">
            <div className="group">
              <div className="text-6xl md:text-7xl lg:text-8xl font-serif font-black mb-2 text-white group-hover:text-[#FFC107] transition-colors">
        ...
        {/* Right Arc & Text */}
        <div className="w-full xl:w-1/3 bg-[#f8f9fa] h-[400px] md:h-[500px] xl:h-[520px] relative z-10 rounded-[4rem] xl:rounded-none xl:rounded-l-full mx-6 xl:mx-0 box-border text-center xl:text-right flex flex-col justify-center p-12 lg:p-20 lg:pr-24 shadow-2xl">
            <h4 className="text-[12px] font-black text-[#0c0e14] uppercase tracking-[0.8em] mb-6">RECRUIT ART IMPACT</h4>
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif font-black text-[#0c0e14] leading-[1.1] mb-8 max-w-sm mx-auto xl:mx-0 xl:ml-auto">
                Our Portfolio.
            </h3>
      ...
      <div className="flex flex-col lg:flex-row min-h-[600px] lg:min-h-[800px] bg-[#0c0e14]">
        ...
        {/* Right side - Text */}
        <div className="w-full lg:w-1/2 bg-[#0c0e14] flex items-center justify-center p-10 md:p-20 lg:p-24 relative text-white">
          <div className="max-w-xl relative z-10 w-full space-y-8 md:space-y-12 py-8 md:py-12">
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-[#FFC107] mb-6">Sector Strategy</h4>
              <h2 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-black text-white leading-[1.1] tracking-tight">
            ...
            {/* <a href="/#footer" className="inline-block bg-[#FFC107] text-[#0c0e14] px-10 py-4 md:py-5 rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#FFC107]/20 hover:scale-105 transition-all whitespace-nowrap">
              Work With Us
            </a> */}

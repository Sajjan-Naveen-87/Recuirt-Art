...
${formData.message || 'No additional message.'}
  ...
  return (
    <section id="contact" className="py-24 bg-[#1a1a1a] relative overflow-hidden scroll-mt-20">
      <div className="flex flex-col items-center px-6 relative z-10 w-full max-w-4xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-serif text-white mb-20 text-center tracking-wide">
